...
class watchedAction extends notify_1.default {
    buildEmbed(args, embed) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, helper_lib_1.MessageEmbed_NoThrow)(embed, 'Actioner', (0, helper_lib_1.OrDefault_NonEmptyString)(info.actioner, "UNDEFINED"));
            (0, helper_lib_1.MessageEmbed_NoThrow)(embed, 'Message', (0, helper_lib_1.OrDefault_NonEmptyString)(info.message, "UNDEFINED"));
        });
    }
}
