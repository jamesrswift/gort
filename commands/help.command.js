...
const command_class_1 = __importStar(require("../core/command.class"));
class helpCommand extends command_class_1.default {
    constructor() {
        super(...arguments);
        this.name = 'help';
    ...
    execute(args, cmd, discordMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const commandHandle = command_class_1.commandHandler.Instance.getHandle();
