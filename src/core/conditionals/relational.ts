...
export class equals<Type> extends relationalOperator<Type, Type, boolean> {
	protected override _predicate(lhs: Type, rhs: Type): boolean {
		return lhs == rhs;
	}
}
...
export class greaterThanOrEquals<Type> extends relationalOperator<
	Type,
	Type,
	boolean
> {
...
export class lessThanOrEquals<Type> extends relationalOperator<
	Type,
	Type,
	boolean
> {
