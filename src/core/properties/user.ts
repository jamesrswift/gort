...
export class has_verified_mail extends redditUserProperty('has_verified_mail') {}
...
export class pref_show_snoovatar extends redditUserProperty('pref_show_snoovatar') {}
