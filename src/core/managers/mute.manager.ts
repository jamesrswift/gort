...
export default class muteManager {
    ...
    public static get Instance(): muteManager { return this._instance || (this._instance = new muteManager()); }
    private constructor() { 
        logger.trace("Constructing muteManager instance");
    }

    private _bMuted: boolean = false;
    public get isMuted(): boolean { return this._bMuted; }
    public set isMuted(toggle: boolean) { this.setMuted(toggle) }
    public toggleMuted(): boolean { return this.setMuted(!this.isMuted) }
